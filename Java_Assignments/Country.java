...
public class Country {
	...
	public String isLargestArea(Country[] country) { // It test largerArea and display the country name
	...
	public String isLargestPopulation(Country[] country) {   //It test largerPopulation and display country name
	...
	public String isLargestPopulationDensity(Country[] country) { //It display larger density of country
