...
public class MoneyMoneyBankTest {
	...
	public void currentAccountNegative() {
		...
		MMCurrentAccount mmCurrentAccount= (MMCurrentAccount)mmBankFactory.getNewCurrentAccount("Jaffar",0,50000);
		try {
	...
	public void currentAccountNormalCheck() {
		BankFactory mmBankFactory=new MMBankFactory();
		MMCurrentAccount mmCurrentAccount= (MMCurrentAccount)mmBankFactory.getNewCurrentAccount("Jaffer",0,50000);
		try {
			mmCurrentAccount.deposit(5000);
			mmCurrentAccount.withdraw(50000);
		} 
		catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void savingsAccount() {
		BankFactory mmBankFactory=new MMBankFactory();
		MMSavingsAccount mmSavingsAccount = (MMSavingsAccount)mmBankFactory.getNewSavingsAccount("Shaik",0,true);
		try {
	...
	public void savingsAccountExceeds() throws Exception {
		...
		MMSavingsAccount mmSavingsAccount = (MMSavingsAccount)mmBankFactory.getNewSavingsAccount("Shaik",0,true);
		try {
			mmSavingsAccount.deposit(50000);
			mmSavingsAccount.withdraw(200000);
		} catch (Exception e) {
			//e.printStackTrace();
